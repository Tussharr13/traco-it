  ...
  return (
    <section className="py-16 bg-ice-blue">
      <div className="container mx-auto">
        <h2 className="mb-12 text-neutral-900 text-4xl font-semibold font-glitten tracking-wider">Travel Needs</h2>
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute top-2 right-0 z-10">
                <Tile
                  className="bg-gray-900 text-white font-onest font-medium px-2 py-0 text-xs shadow-md"
                >
                  Coming Soon
                </Tile>
              </div>
